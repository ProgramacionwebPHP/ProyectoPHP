                ...
                <div class="col-md-12 ">
                    <form method="post" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]."?user=".$usuario);?>"> 
                        ...
                        while($fila = mysqli_fetch_array($datos)) {
                            ...
                            $str_datos .= "<tr>";
                            $str_datos .= "<td>". $fila ['Nombre'] . "</td><td>" . $fila ['Diagnostico']. "</td><td>" . $aux2. "</td><td>" . $fila ['TiempoDeDuracion']. " dias</td><td>" . $fila ['FechaDeIngreso']. "</td><td>Nº.". $fila ['IDHabitacion']. "</td><td>Nº." . $fila ['IDCama']. "</td><td>" . $medico ['Nombre']. "</td><td> <a href=\"equipos.php?user=". $usuario."&paciente=".$fila ['ID']."\"><i class=\"far fa-eye\"></i> Ver equipos</a></td>";
                            $str_datos .= "</tr>";
                        }
                        $str_datos .= "</table>";
                        echo $str_datos;
